...
class FCA{
    ...
    void gradientDim2(LAVector&, LAVector&, double[]);//Método para calcular el gradiente
...
public:
    ...
    void optimizeDim2(LAMatrix&);//Optimización para el caso de dimensión 2
    ...
    void unmixDim2();//Separada dos matrices
